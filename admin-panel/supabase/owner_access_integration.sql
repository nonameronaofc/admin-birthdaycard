-- =====================================================================
-- Owner Access Integration for Admin Panel
-- Jalankan di Supabase SQL Editor pada project yang sama dengan admin,
-- customer, dan owner panel.
-- =====================================================================
-- File ini aman dijalankan meskipun owner panel belum dideploy.
-- Jika kamu sudah menjalankan web-owner/supabase/owner_schema.sql,
-- file ini hanya memastikan tabel yang dibutuhkan tetap tersedia.
...
-- Seed manual setelah user owner dibuat di Supabase Auth:
